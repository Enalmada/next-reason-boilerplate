    ...
    <Layout>
      <Layout.Header>
        <Antd_Menu
          ...
          <Antd_Menu.Item key="signin" style={ReactDOMRe.Style.make(~float="right", ())}>
            <ProfileModule />
          </Antd_Menu.Item>
        </Antd_Menu>
      </Layout.Header>
...
let default = ReasonReact.wrapReasonForJs(~component, jsProps => make(~nav=jsProps##nav, jsProps##children));
